...
In this repo, we provide Recommenders artwork in 2 standard formats (PNG/SVG), and in 3 versions (color/black/white). We also provide the icon of the logo in in 2 standard formats (PNG/SVG), and in 3 versions (color/black/white).
